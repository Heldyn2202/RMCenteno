...
<head>
    ...
    <title>Búsqueda | Portal Escolar</title>
...
<body>
    ...
    // Configuración de paginación para búsqueda
    ...
    $total_pages_sql = "SELECT COUNT(*) FROM tblposts WHERE tblposts.PostTitle like '%$st%' and tblposts.Is_Active=1";
    $result = mysqli_query($con,$total_pages_sql);
    $total_rows = mysqli_fetch_array($result)[0];
    $total_pages = ceil($total_rows / $no_of_records_per_page);

    // Obtener posts para la búsqueda actual
    ...
    <div class="content-area">
        <div class="container">
            ...
            <h1 class="section-title text-blue">Resultados de Búsqueda</h1>
            <ol class="breadcrumb">
            ...
            <div class="search-form">
                <form method="post" action="">
                    <div class="input-group">
                        <input type="text" name="searchtitle" class="form-control form-control-lg" placeholder="Buscar noticias..." value="<?php echo htmlentities($st); ?>">
            ...
            <div class="results-count">
                <p class="mb-0">
                    <?php 
                    if($rowcount == 0) {
                        echo "No se encontraron resultados para: <strong>".htmlentities($st)."</strong>";
                    } else {
                        echo "Se encontraron ".$rowcount." resultado(s) para: <strong>".htmlentities($st)."</strong>";
                    }
                    ?>
                </p>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="alert-no-content">
                    ...
                    <p>Intente con otros términos de búsqueda o explore nuestras categorías de noticias.</p>
