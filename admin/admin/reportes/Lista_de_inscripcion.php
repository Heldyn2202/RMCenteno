        ...
        <div class="container">  
            <div class="content-header">  
                <div class="container-fluid">  
                    <div class="row mb-2">  
                        <div class="col-sm-6">  
                            <h1 class="m-0">Constancias de inscripción</h1>  
                        </div><!-- /.col -->  
                        <div class="col-sm-6">  
                        ...
                        <div class="col-md-12">  
                            <div class="card card-outline card-primary">  
                                <div class="card-header">
                                    <h3 class="card-title">Lista de Constancias de Inscripción</h3>
                                    <div class="card-tools">
                                        <span class="badge badge-primary">Total: <?= $total_inscripciones; ?></span>
                                    </div>
                                </div>
                                <div class="card-body">  
                                    <table id="example1" class="table table-striped table-bordered table-hover table-sm">  
                                        ...
                                        <tbody>  
                                            ...
                                            ?>  
                                                <tr>  
                                                    <td style="text-align: center"><?= $contador_inscripciones; ?></td>
                                                    ...
                                                    <td><?= htmlspecialchars($turno_map[$inscripcion['turno_id']]); ?></td>
                                                    ...
                                                    <td style="text-align: center">  
                                                        <div class="btn-group" role="group" aria-label="Acciones">
                                                            <a href="generate_certificate.php?id_estudiante=<?= htmlspecialchars($inscripcion['id_estudiante']); ?>" 
                                                               target="_blank" 
