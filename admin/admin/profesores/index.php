                ...
                <div class="col-md-6 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b>Lista de profesores</b></span>
                            <a href="listar_profesores.php" class="btn btn-info btn-sm">Ver</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b>Lista de Estudiantes por profesores</b></span>
