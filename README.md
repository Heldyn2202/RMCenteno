...
1.  **Clonar el repositorio**:
    ```bash
    git clone [https://github.com/Heldyn2202/RMCenteno.git](https://github.com/Heldyn2202/RMCenteno.git)
    ```

2.  **Importar la base de datos** (`sige`):
    Ejecutar el archivo `sige.sql` en MySQL (o importar el archivo que contiene la estructura y datos de prueba).

3.  **Configurar conexión a la base de datos**:
    Editar el archivo de configuración en `sige/config/config.php` con tus credenciales de MySQL.

4.  **Acceder al sistema**:
    Abrir en el navegador: `http://localhost/heldyn/centeno/admin` (Ajusta la URL según la estructura de tu proyecto en XAMPP).

## 👤 Credenciales de Prueba

| Rol | Usuario | Contraseña | Permisos |
| :--- | :--- | :--- | :--- |
| **Administrador** | `admin@gmail.com` | `123456` | Acceso completo al sistema |
| **Profesor** | (Añadir un email de prueba) | (Añadir contraseña) | Carga de notas y gestión de estudiantes |
...
[![GitHub](https://img.shields.io/badge/GitHub-Heldyn2202-black?style=flat&logo=github)](https://github.com/Heldyn2202)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Perfil-0A66C2?style=flat&logo=linkedin)](https://www.linkedin.com/in/heldyn-diaz-daboin-17306822b/)
...
## 📦 Instalación y Uso
1. *Clonar el repositorio*:
en bash, -> git clone https://github.com/Heldyn2202/RMCenteno.git
